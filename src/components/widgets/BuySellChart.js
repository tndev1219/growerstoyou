...
class BuySellChart extends React.Component {
   state = {
      ...
      chartData: {
         data:[
            { name: 'Monday', Buy: 1000, Sell: 2400, Transfer: 2400, uvError: [75, 20] },
            { name: 'Tuesday', Buy: 300, Sell: 4567, Transfer: 2400, uvError: [90, 40] },
            { name: 'Wednesday', Buy: 280, Sell: 1398, Transfer: 2400, uvError: 40 },
            { name: 'Thirsday', Buy: 200, Sell: 9800, Transfer: 2400, uvError: 20 },
            { name: 'Friday', Buy: 278, Sell: 4000, Transfer: 2400, uvError: 28 },
            { name: 'Saturday', Buy: 189, Sell: 4800, Transfer: 2400, uvError: [90, 20] },
            { name: 'Sunday', Buy: 189, Sell: 4800, Transfer: 2400, uvError: [28, 40] }
          ]
      },
   };
   componentDidMount() {
