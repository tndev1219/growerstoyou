                     ...
                     <Table className="table-wrap">
                        ...
                        <TableBody>
                           {transactionList.map((list, index) => (
                              <TableRow key={index}>
                                 <TableCell>1{list.transid}</TableCell>
                                 <TableCell>2018-03-13{list.date}</TableCell>
                                 <TableCell>test{list.account}</TableCell>
                                 <TableCell><Chip label={list.type} className={list.typeColor} /></TableCell>
                                 <TableCell>$20{list.amount}</TableCell>
                                 <TableCell>test{list.debit}</TableCell>
                                 <TableCell>$100{list.balance}</TableCell>
                              </TableRow>
                           ))}
                        </TableBody>
                     </Table>
                     ...
                     <Table className="table-wrap" >
                        ...
                        <TableBody>
                           {transferReport.map((list, index) => (
                              <TableRow key={index}>
                                 <TableCell>1{list.transid}</TableCell>
                                 <TableCell>2018-02-25{list.date}</TableCell>
                                 <TableCell>test{list.account}</TableCell>
                                 <TableCell><Chip label={list.type} className={list.typeColor} /></TableCell>
                                 <TableCell>$20{list.amount}</TableCell>
                                 <TableCell>460{list.balance}</TableCell>
                     ...
                     <Table className="table-wrap" >
                        ...
                        <TableBody>
                           {expenseCategory.map((list, index) => (
                              <TableRow key={index}>
                                 <TableCell>1{list.itmNo}</TableCell>
                                 <TableCell>2018-01-20{list.date}</TableCell>
                                 <TableCell><Chip label={list.type} className={list.typeColor} /></TableCell>
                                 <TableCell>Test{list.companyName}</TableCell>
                                 <TableCell>$420{list.amount}</TableCell>
                                 <TableCell><Chip label={list.status} className={list.statusColor} /></TableCell>
                              </TableRow>
                           ))}
                        </TableBody>
