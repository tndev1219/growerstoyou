...
import FarmerNav from '../layouts/farmer-nav/FarmerNav';
import FarmerSidebar from '../layouts/farmer-sidebar';

class FarmerAdmin extends Component {
   ...
   render() {
      ...
      const { windowWidth } = this.state;
      return (
         <div className="frontend farmer-panel">
            <Sidebar
