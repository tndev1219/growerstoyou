...
const { login, waiting } = authAction;
...
class HomePage extends React.Component {
  ...
  handleSubmit = () => {
    const { login, waiting } = this.props;
    waiting(true);
                  ...
                  <Grid container className="section-content" direction="column" justify="center" alignItems="center">
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                     ...
                     >
                      ...
                      {this.props.wait && <CircularProgress size={24} style={{position: "absolute", marginTop: "8px", marginLeft: "-90px"}} />}
                    </Grid>
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
                      <p className="lead"><Link to="/forgot-password">Forgot Password?</Link></p>
                    </Grid>
                    <Grid item xs={12} sm={12} md={12} lg={12} xl={12}>
