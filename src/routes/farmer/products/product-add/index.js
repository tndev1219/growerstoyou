...
import { Grid, Button, TextField, Select, Input, MenuItem, CircularProgress, InputAdornment } from '@material-ui/core';
...
class ProductAdd extends React.Component {
  constructor(props) {
    ...
    this.state = {
    pictures: [
      "products/default_preview.png", 
      "products/default_preview.png", 
      "products/default_preview.png", 
      "products/default_preview.png", 
      "products/default_preview.png"
    ],
    preview_image: 'products/default_preview.png',
    category: [],
    selectedCategory: 1,
    selectedUnit:1,
    unit: [],
  ...
  onDrop(picture, index) {
    if (picture.length === 0) {
      ...
      pictures[index] = "products/default_preview.png";
  ...
  handleValidation = () => {
    ...
    //Product Image
    for (var i = 0; i < 5; i++) {
      if (this.state.pictures[i] === "products/default_preview.png") {
        formIsValid = false;
      } else {
        break;
      }
  ...
  handleSubmit = () => {
    ...
    var unit = this.state.unit.filter(unit => unit.id === this.state.selectedUnit);
    var payload = {
  ...
  changePreviewImage = (preview_image) => {
    this.setState({ preview_image });
  };
  
  render() {
    var { pictures, preview_image } = this.state;
    return (
            ...
            <Grid container spacing={4} className="my-0">
              <Grid item xs={12} sm={12} md={6} lg={6} className="py-0 mb-md-0 mb-30">
                <Grid container spacing={3} className="iron-product-gallery my-0">
                  <Grid item xs={3} sm={2} md={2} lg={2} className="py-0" style={{padding: 10}}>
                  ...
                  <Grid item xs={9} sm={10} md={10} lg={10} className="py-0">
                    <div className="preview-full-image iron-shadow product-gallery-item product-preview-image">
                      <a href="javascript:void(0)">
                        <img
                          src={`${appConfig.S3_BUCKET}${preview_image}`}
                          alt="poster-image"
                        />
                      </a>
                    </div>
              ...
              <Grid item xs={12} sm={12} md={6} lg={6} className="py-0">
                <div className="detail-content">
                  ...
                  <form className="product-values">
                    ...
                    <div className="mb-25">
                      <h6 className="text-14 mb-0 add-text">Add Price/Unit :</h6>
                      <Input
                    ...
                    <div className="mb-10">
                      <h6 className="text-14 mb-0 add-text">select category :</h6>
                      <Select
                        name="category"
                  ...
                  <div className="mb-sm-50 mb-20 detail-btns">
                    <Button className="button btn-active btn-lg btn-disabled mr-15 mb-20 mb-sm-0" onClick={this.handleClick} disabled={this.props.wait}>create</Button>
                    {this.props.wait && <CircularProgress size={24} style={{position: "absolute", marginTop: "14px", marginLeft: "-110px"}} />}
                    <Button to={'products'} component={Link} className="button btn-base btn-lg mb-20 mb-sm-0">discard</Button>
                  </div>
                </div>
              </Grid>
            </Grid>
